...
/* TODO:
	- addEntry button in top right
		- collect selected data and create entry
*/
...
//				cell.leftLabel.constraint()
			...
			default:
				// amount
//				guard let cell = tableView.dequeueReusableCell(withIdentifier: AmountFieldTableViewCell.reuseIdentifier, for: indexPath) as? AmountFieldTableViewCell else {
//					fatalError("Unexpected Index Path")
//				}
//				cell.textField.delegate = cell.self
//				// pass string by reference with wrapper
